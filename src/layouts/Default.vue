  ...
  >
    <header class="fixed w-full z-10 top-0" :class="{'bg-white shadow':(theme === 'theme-light')}">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8 px-4">
        ...
        <ul
          class="tracking-normal font-semibold w-full block flex-grow lg:flex lg:flex-initial lg:w-auto items-center mt-8 lg:mt-0"
    ...
    <footer class="bg-indigo-500 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          ...
          <li class="mr-8">
            <a
              href="https://github.com/webmatters/wm-site"
              target="_blank"
          ...
          <li class="mr-8">
            <a
              href="https://twitter.com/thewebmatters"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
