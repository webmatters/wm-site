    ...
    <div class="newsletter bg-background-tertiary">
      <div class="container-inner mx-auto py-16 pb-8 text-center textl-xl">
        ...
        <div class="w-4/5 mx-auto mb-8">
          <div class="mb-8 text-lg sm:text-xl">
            We'll send you updates and articles to help move your business
            forward.
          </div>
          ...
          >
            <div class="flex flex-col sm:flex-row">
              ...
              <button
                data-element="submit"
                class="flex-2 w-40 uppercase bg-indigo-600 text-white rounded sm:rounded-l-none text-lg py-3 px-8 tracking-wide shadow focus:outline-none hover:bg-indigo-500 focus:bg-indigo-600 z-10 w-full sm:w-auto mt-4 sm:mt-0"
              >
                <span>Subscribe</span>
              </button>
            </div>
